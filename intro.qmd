...
footprinting data using [fmicompbio/SingleMoleculeGenomicsIO]{.githubpkg} and
[fmicompbio/footprintR]{.githubpkg}:
...
methylation status using [regroupReads]{.fnio}, or across multiple genomic
